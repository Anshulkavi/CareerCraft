...
export default function ResumeGrammarChecker() {
  useEffect(() => {
    AOS.init({ duration: 1000, once: false }); // animations happen on every scroll up/down
  }, []);

  return (
    <div
      className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-20 px-6 md:px-8 lg:px-16 overflow-hidden relative"
      data-aos="fade-up"
    >
      {/* Content container */}
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          {/* Left side - Text content */}
          <div className="w-full md:w-5/12" data-aos="fade-right" data-aos-delay="200">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 dark:!text-blue-600 mb-6 leading-tight">
              Check your resume for grammatical and punctuation errors
            </h2>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start gap-3" data-aos="fade-up" data-aos-delay={300 + i * 100}>
                  <div className="mt-1 flex-shrink-0">
                    <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
                      <svg
                        className="w-4 h-4 text-green-500"
          ...
          {/* Right side - Resume mockup */}
          <div className="w-full md:w-7/12 relative" data-aos="fade-left" data-aos-delay="400">
            {/* Curved arrow graphic */}
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/4 md:-translate-x-1/2 w-1/2 h-1/2 pointer-events-none">
              <svg
                className="w-full h-full text-gray-700"
...
<div
  className="
    absolute top-6 right-4 bg-white rounded-lg shadow-xl
    p-3 md:p-4 max-w-[260px] md:max-w-xs z-10
