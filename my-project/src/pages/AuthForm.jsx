...
//       {/* Left Section */}
//       <div className="w-1/2 bg-white px-16 py-20 flex flex-col justify-center">
...
//       {/* Right Section */}
//       <div className="w-1/2 bg-gradient-to-br from-[#06070d] to-[#0b06a0] flex justify-center items-center">
...
function AuthForm() {
  ...
  return (
    <div className="min-h-screen flex font-[Poppins] flex-col lg:flex-row">
      ...
      {/* Right Section */}
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-[#06070d] to-[#0b06a0] flex justify-center items-center">
        <div className="w-[350px] bg-white rounded-lg shadow-lg p-8 text-center my-10">
          <h2 className="text-[#303f9f] text-2xl font-semibold mb-6">
            {isLogin ? "Log In" : "Sign Up"}
          </h2>
