...
from .views import upload_resume,SaveResumeView,GetResumeView, get_resume_by_id, DeleteResumeView
from . import views
...
urlpatterns = [
    ...
    path('delete-resume/<str:resume_id>/', DeleteResumeView.as_view(), name='delete-resume'),
