...
SECRET_KEY = 'django-insecure-z9zd+&95%(j2#8-+npkd&e&^8*bk09owu8407h(sv3zxbjf#4@'
...
# URL for accessing the media files
MEDIA_URL = '/media/'

# Specific folder for resume files (optional)
RESUME_UPLOAD_DIR = os.path.join(MEDIA_ROOT, 'resumes')


# Increase the file upload limit (e.g., to 10MB)
...
CELERY_REDIS_BACKEND_USE_SSL = {
    'ssl_cert_reqs': ssl.CERT_NONE  # You can use CERT_REQUIRED if you want validation
}

# Optional: To avoid serialization issues
